...
export const Logo = ({ width = 50, height = 32, fill, className, ...props }: LogoProps) => {
	const router = useRouter()

	// Use a fill color that works in both light and dark modes if none is provided
	const logoFill = fill || "var(--logo-color, currentColor)"
