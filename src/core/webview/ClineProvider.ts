...
export class ClineProvider extends EventEmitter<ClineProviderEvents> implements vscode.WebviewViewProvider {
	...
	*/
	...
	public async handleModeSwitch(newMode: Mode) {
		...
		// Get the mode-specific temperature setting and apply it to the current Cline instance
		const modeTemperature = await this.providerSettingsManager.getModeTemperature(newMode)

		// Update the API handler with the mode-specific temperature if a Cline instance exists
		if (this.getCurrentCline()) {
			const apiConfiguration = this.contextProxy.getProviderSettings()
			const model = this.getCurrentCline()!.api.getModel()
			...
			apiConfig._modeTemperature = modeTemperature

			this.getCurrentCline()!.api = buildApiHandler(apiConfig)
		}
	...
	async getStateToPostToWebview() {
		...
		return {
			...
			modeTemperatures: modeTemperatures ?? {},
		}
	}
	...
	async getState() {
		...
		return {
			...
			modeTemperatures: stateValues.modeTemperatures ?? {},
		}
	}
