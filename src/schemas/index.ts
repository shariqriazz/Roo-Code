...
/**
 * ModeTemperatureSettings
 */

export const modeTemperatureSettingsSchema = z.record(z.string(), z.number().nullish())

export type ModeTemperatureSettings = z.infer<typeof modeTemperatureSettingsSchema>
...
export const globalSettingsSchema = z.object({
	...
	// Mode-specific temperature settings
	modeTemperatures: modeTemperatureSettingsSchema.optional(),
