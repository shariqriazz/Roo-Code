...
export function buildApiHandler(configuration: ApiConfiguration): ApiHandler {
	...
	// _modeTemperature is passed through options to getModelParams
	switch (apiProvider) {
		case "anthropic":
...
export function getModelParams({
	...
	// Use mode-specific temperature if available, otherwise fall back to profile temperature
	// Convert null to undefined since the APIs don't accept null
	let temperature = _modeTemperature !== undefined ?
		(_modeTemperature === null ? undefined : _modeTemperature) :
		(customTemperature ?? defaultTemperature)
